...
export const metadata: Metadata = {
  title: "مؤسسة سدرا المعاني : سباك.. وتشطيبات وشلالات مياه  ونوافير منزليه  وعزل  ولياسه ونقاشه وصيانه منازل ورفع كفائه",
  description:
    "سباكه - عزل - شلالات مياه - نوافير - نقاشه - لياسه - صيانه عامه للمنازل بالدمام والخبر | اتصل بنا: 0542693935",
  keywords: [
    "سدرا المعاني",
    "سدره المعاني",
    "سدرا المعانى",
  ...
  authors: [{ name: "مؤسسة سدرا المعاني" }],
  robots: "index, follow",
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "مؤسسة سدرا المعاني للمقاولات والتشطيبات",
      },
    ],
  },
  twitter: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "name": "مؤسسة سدرا المعاني : سباك.. وتشطيبات وشلالات مياه  ونوافير منزليه  وعزل  ولياسه ونقاشه وصيانه منازل ورفع كفائه",
    "alternateName": [
      "سدرا المعاني",
      "سدره المعاني",
      "سدرا المعانى",
      "سدره المعانى",
      "مؤسسة سدرا المعاني للمقاولات",
      "مؤسسه سدره المعانى للمقاولات"
    ],
