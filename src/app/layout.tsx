...
export const metadata: Metadata = {
  title: "مؤسسة سدرة المعاني للمقاولات والتشطيبات بالدمام والخبر | 0542693935",
  description:
    "للتواصل والاتصال: 0542693935. مؤسسة سدرة المعاني متخصصة في السباكة والصحي، عوازل الأسطح، أعمال اللياسة والتشطيبات، شلالات مياه ونوافير بالمنطقة الشرقية.",
  keywords: [
    "سدرة المعاني",
    "سدره المعاني",
    "سدرة المعانى",
  ...
  openGraph: {
    ...
    description:
      "تنفيذ أعمال المقاولات والتشطيبات والصيانة وشلالات المياه والنوافير بالدمام والخبر بأعلى معايير الجودة والسرعة.",
  ...
  twitter: {
    ...
    title: "مؤسسة سدرة المعاني للمقاولات والتشطيبات والصيانة ورفع الكفاءة",
    description:
      "تنفيذ أعمال المقاولات والتشطيبات والترميم والصيانة وشلالات المياه بالمنطقة الشرقية بأعلى معايير الجودة.",
