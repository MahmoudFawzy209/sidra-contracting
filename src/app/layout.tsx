...
export const metadata: Metadata = {
  title: "سدرا المعاني : سباك.. وتشطيبات وشلالات مياه  ونوافير منزليه  وعزل  ولياسه ونقاشه وصيانه منازل ورفع كفائه",
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "سدرا المعاني للمقاولات والتشطيبات",
      },
    ],
  },
  twitter: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "name": "سدرا المعاني : سباك.. وتشطيبات وشلالات مياه  ونوافير منزليه  وعزل  ولياسه ونقاشه وصيانه منازل ورفع كفائه",
    "alternateName": [
      "سدرا المعاني",
      "سدره المعاني",
      "سدرا المعانى",
      "سدره المعانى",
      "سدرا المعاني للمقاولات",
      "سدره المعانى للمقاولات"
    ],
