        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-base text-gray-600 leading-relaxed mb-8">
              تأسست <strong>مؤسسة سدرا المعاني للمقاولات العامة</strong> لتكون علامة فارقة في قطاع الإنشاءات والتشطيبات بالمملكة العربية السعودية. نحن نؤمن بأن كل مشروع هو قصة نجاح جديدة، لذلك نحرص على تقديم خدمات متكاملة تغطي كافة متطلبات البناء والصيانة ورفع الكفاءة التشغيلية والإنشائية للمباني بأعلى مستويات الاحترافية والدقة.
            </p>
