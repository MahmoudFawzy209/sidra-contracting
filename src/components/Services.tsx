...
export default function Services() {
  const services: ServiceItem[] = [
    ...
    },
    {
      ...
      description: "تنفيذ أعمال الدهانات والتشطيبات الداخلية والخارجية بواسطة نقاش بالدمام ذو خبرة، مع خدمات تشطيبات بالدمام للفلل والمنشآت.",
    ...
    },
    {
      ...
      title: "أعمال اللياسة",
      description: "تنفيذ أعمال اللياسة الداخلية والخارجية باحترافية وتجهيز الأسطح؛ نوفر مقاول ومعلم لياسه بالدمام لتأمين واستعدال الجدران المائلة.",
    ...
    },
    {
      ...
      description: "حلول احترافية يقدمها مقاول ومتخصصين عوازل بالدمام لحماية الأسطح وعزل الحمامات والمطابخ.",
